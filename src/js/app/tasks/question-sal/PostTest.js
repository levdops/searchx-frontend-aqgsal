...
const formData = function(topic) {
    ...
    elements.push({
        ...
        html: `
            ...
            <b> Based on what you have learned from the search session about the topic, please write, in your own words, a summary at a minimum of 100 words.  Note that if your summary is less than 100 words, you will be alerted to it when you try to submit your answers.</b>
    ...
    return {
        ...
        completedHtml: "<h2>Thank you for taking part in our study.</h2> <h3>Follow <a href=" + constants.completionURL + "> this link</a> back to Prolific Academic to confirm your participation.</h3>" ,
    }
};
