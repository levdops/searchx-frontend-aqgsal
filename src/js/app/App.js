...
import SsalRegister from './tasks/question-sal/Register';
import SsalDisqualified from './tasks/question-sal/Disqualified';
import SsalPreTest from './tasks/question-sal/PreTest';
import SsalIntermediateTests from './tasks/question-sal/IntermediateTests';
import SsalPostTest from './tasks/question-sal/PostTest';
import SsalSession from './tasks/question-sal/Session';
import SsalLongtermPost from './tasks/question-sal/LongtermRegister';
import SsalLongtermTest from './tasks/question-sal/LongtermRetentionTest';
import SsalQualityPost from './tasks/question-sal/QuestionQalityRegister';
import SsalQualityTest from './tasks/question-sal/QuestionQualityEvaluation';
...
export class App extends React.Component {
    ...
    render() {
        ...
        <Route path="/qhw/submission" component={QHWSubmission}/>*/}
                    ...
                    <Route exact path="/ssal" component={SsalRegister}/>
                    <Route exact path="/disq" component={SsalDisqualified}/>
                    <Route exact path="/ssal/pretest" component={SsalPreTest}/>
                    <Route exact path="/ssal/intermediatetest" component={SsalIntermediateTests}/>
                    <Route exact path="/ssal/posttest" component={SsalPostTest}/>
                    <Route path="/ssal/session" component={SsalSession}/>
                    <Route exact path="/ssal/longterm" component={SsalLongtermPost} />
                    <Route exact path="/ssal/longtermposttest" component={SsalLongtermTest} />
                    <Route exact path="/ssal/qquality" component={SsalQualityPost} />
                    <Route exact path="/ssal/qqualitytest" component={SsalQualityTest} />
                </div>
            </Router>
        );
    }
